...
import { CalendarDays, LayoutDashboard, Stethoscope, User, Users } from 'lucide-react';
...
export default function Sidebar() {
  ...
  return (
    <aside className="flex h-screen w-72 flex-col gap-4 bg-emerald-800 text-emerald-50">
      <div className="justify-left sticky top-0 flex h-16 items-center border-b border-emerald-700 bg-emerald-800 p-6">
      ...
      <div className="mt-auto border-t border-emerald-700 p-4">
        <Link
          to="/"
